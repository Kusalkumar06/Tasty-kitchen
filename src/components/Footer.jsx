  ...
  return (
    <div className="w-full h-[200px] md:h-[300px] bg-[#0F172A] flex flex-col items-center justify-center md:mt-[40px]">
      <div className="flex items-center justify-center mb-2">
        <img className="w-[36px] h-[29px] md:w-[49px] md:h-[39px] mr-2" src="https://res.cloudinary.com/dtrouncfb/image/upload/v1754081562/Frame_275_equrac.png" />
        <p className="text-white text-[20px] md:text-[30px]">Tasty Kitchens</p>
      </div>
      <p className="text-[14px] md:text-[24px] mb-1 text-white"> The only thing we are serious about is food. </p>
      <p className="text-[14px] md:text-[24px] mb-[25px] text-white"> Contact us on </p>
